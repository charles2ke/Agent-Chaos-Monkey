...
125 words per minute, with a 1.2 second pause between steps so the tour is easy
to follow. This is an offline synthetic approximation of a youthful
British female presenter, not a recorded human or neural voice.
